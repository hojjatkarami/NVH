...
T_Amp = TorqueAmp;    % N/m
T_Freq = IdleSpeed/60;    % Rad/s
T_phase = 0;    % Radian

%% Stiffness Matrix
% Mount Positions

r_1 = cell2mat(r(1))* 1e-3;
r_2 = cell2mat(r(2))* 1e-3;
r_3 = cell2mat(r(3))* 1e-3;
...
% Mount Inclinations
o_1 = cell2mat(o(1))'*pi/180;
o_2 = cell2mat(o(2))'*pi/180;
o_3 = cell2mat(o(3))'*pi/180;
...
% Mo  unt Stiffness
k_l_1 = diag(cell2mat(k_l(1)))*1e3;
k_l_2 = diag(cell2mat(k_l(2)))*1e3;
k_l_3 = diag(cell2mat(k_l(3)))*1e3;
k_1 = A_1*k_l_1*A_1';
k_2 = A_2*k_l_2*A_2';
k_3 = A_3*k_l_3*A_3';
...
c_l_1 = diag(cell2mat(c_l(1)));
c_l_2 = diag(cell2mat(c_l(2)));
c_l_3 = diag(cell2mat(c_l(3)));
c_1 = A_1*c_l_1*A_1';
c_2 = A_2*c_l_2*A_2';
c_3 = A_3*c_l_3*A_3';
